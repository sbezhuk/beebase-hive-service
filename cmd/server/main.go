...
func run() error {
	...
	hiveService := apphive.NewService(hiveRepo, apiaryVerifier, inspectionDeleter, mediaDeleter, subscriptionClient)
	hiveHandler := hivehttp.NewHandler(hiveService, log, cfg.PublicBaseURL)
