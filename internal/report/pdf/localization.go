...
var requiredKeys = []string{
	...
	"report.replacement_reason", "report.year_color", "report.no_replacement", "report.no_current_queen", "report.no_assessment", "report.inspection_date",
...
var enText = map[string]string{
	...
	"report.total": "Total", "report.count": "Count", "report.amount": "Amount", "report.product": "Product", "report.unit": "Unit", "report.introduced": "Introduced", "report.removed": "Removed", "report.replacement_reason": "Replacement reason", "report.year_color": "Year / color", "report.no_replacement": "Not recorded", "report.no_current_queen": "No current queen", "report.no_assessment": "No assessment details.", "report.inspection_date": "Inspected", "report.health_dimension": "Dimension", "report.health_evidence": "Evidence", "report.history_date": "History date", "report.no_history_points": "No points",
