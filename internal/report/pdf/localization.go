...
var requiredKeys = []string{
	...
	"report.qr_instruction", "report.date", "report.type", "report.assessment", "report.state", "report.coverage", "report.overall_health", "report.data_coverage", "report.data_coverage_explanation", "report.insufficient_data",
